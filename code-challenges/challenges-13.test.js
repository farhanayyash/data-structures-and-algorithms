...
const longestString = (arr) => {
 ...
 return y
  ...
  console.log(longestString(strArray1))
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
const firstLetters = (arr) => {
  return arr.map(el =>  el.substring(0,1));
};
...
console.log(findHappiness(['this is great :)', 'wow', 'whyyyyyy :(', ':)))))']))
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
console.log(onlyOddChars("0123456789"));
